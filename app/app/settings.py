...
ALLOWED_HOSTS = env.list(
    "ALLOWED_HOSTS", default=["localhost", "127.0.0.1", "0.0.0.0", "lev4ek.ru"]
)
...
LOCAL_APPS = ["geography", "stats", "users", "events"]
...
SPECTACULAR_SETTINGS = {
    "TITLE": "Grapes Dashboard",
    "DESCRIPTION": "Grapes Dashboard REST API",
    "VERSION": "0.0.1",
